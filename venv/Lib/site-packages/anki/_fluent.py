...
optimizing the parameters. '''
    ...
    def deck_config_confirm_remove_name(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(11, 35, {"name": name})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(11, 38, {"cards": cards})
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_400_reviews(self, count: int) -> str:
        ...
        return self._translate(11, 85, {"count": count})
...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_optimizing_preset(self, current_count: int, total_count: int) -> str:
        ...
        return self._translate(11, 111, {"current_count": current_count, "total_count": total_count})
    ...
    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        ...
        return self._translate(11, 113, {"reviews": reviews, "pct": pct})
    ...
    def deck_config_predicted_minimum_recommended_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 115, {"num": num})


    def deck_config_predicted_optimal_retention(self, num: FluentVariable) -> str:
        r''' Minimum recommended retention: {$num} '''
        return self._translate(11, 116, {"num": num})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 132, {"cards": cards, "expected": expected})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 169, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 170, {"decks": decks})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS = (11, 33)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP = (11, 34)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (11, 35)
    DECK_CONFIG_CUSTOM_SCHEDULING = (11, 36)
    DECK_CONFIG_CUSTOM_SCHEDULING_TOOLTIP = (11, 37)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (11, 38)
    DECK_CONFIG_DAILY_LIMITS = (11, 39)
    DECK_CONFIG_DAYS_TO_SIMULATE = (11, 40)
    DECK_CONFIG_DECK_ONLY = (11, 41)
    DECK_CONFIG_DEFAULT_NAME = (11, 42)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING = (11, 43)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING_HINT = (11, 44)
    DECK_CONFIG_DESIRED_RETENTION = (11, 45)
    DECK_CONFIG_DESIRED_RETENTION_BELOW_OPTIMAL = (11, 46)
    DECK_CONFIG_DESIRED_RETENTION_TOOLTIP = (11, 47)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 48)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 49)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 50)
    DECK_CONFIG_DO_NOT_BURY = (11, 51)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 52)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 53)
    DECK_CONFIG_EVALUATE_BUTTON = (11, 54)
    DECK_CONFIG_FSRS_MUST_BE_ENABLED = (11, 55)
    DECK_CONFIG_FSRS_ON_ALL_CLIENTS = (11, 56)
    DECK_CONFIG_FSRS_PARAMS_OPTIMAL = (11, 57)
    DECK_CONFIG_FSRS_TOOLTIP = (11, 58)
    DECK_CONFIG_GET_PARAMS = (11, 59)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 60)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 61)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 62)
    DECK_CONFIG_HISTORICAL_RETENTION = (11, 63)
    DECK_CONFIG_HISTORICAL_RETENTION_TOOLTIP = (11, 64)
    DECK_CONFIG_IGNORE_BEFORE = (11, 65)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP = (11, 66)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 67)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 68)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 69)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 70)
    DECK_CONFIG_ITERATIONS = (11, 71)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 72)
    DECK_CONFIG_LEARNING_STEPS = (11, 73)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 74)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 75)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 76)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 77)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 78)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 79)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 80)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 81)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 82)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 83)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 84)
    DECK_CONFIG_MUST_HAVE_400_REVIEWS = (11, 85)
    DECK_CONFIG_NAME_PROMPT = (11, 86)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 87)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 88)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 89)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 90)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 91)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 92)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 93)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 94)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 95)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 96)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 97)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 98)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 99)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 100)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 101)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 102)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 103)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 104)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 105)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 106)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 107)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 108)
    DECK_CONFIG_OPTIMIZE_ALL_TIP = (11, 109)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 110)
    DECK_CONFIG_OPTIMIZING_PRESET = (11, 111)
    DECK_CONFIG_ORDERING_TITLE = (11, 112)
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 113)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 114)
    DECK_CONFIG_PREDICTED_MINIMUM_RECOMMENDED_RETENTION = (11, 115)
    DECK_CONFIG_PREDICTED_OPTIMAL_RETENTION = (11, 116)
    DECK_CONFIG_RELEARNING_STEPS = (11, 117)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 118)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 119)
    DECK_CONFIG_REMOVE_GROUP = (11, 120)
    DECK_CONFIG_RENAME_GROUP = (11, 121)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 122)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 123)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 124)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 125)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 126)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 127)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 128)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 129)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 130)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 131)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 132)
    DECK_CONFIG_SAVE_AND_OPTIMIZE = (11, 133)
    DECK_CONFIG_SAVE_BUTTON = (11, 134)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 135)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 136)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP_2 = (11, 137)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 138)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_2 = (11, 139)
    DECK_CONFIG_SHARED_PRESET = (11, 140)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 141)
    DECK_CONFIG_SHOW_REMINDER = (11, 142)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 143)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 144)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 145)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 146)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 147)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 148)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 149)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 150)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 151)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 152)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 153)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 154)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 155)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 156)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 157)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 158)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 159)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 160)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 161)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 162)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 163)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 164)
    DECK_CONFIG_TIMER_TITLE = (11, 165)
    DECK_CONFIG_TITLE = (11, 166)
    DECK_CONFIG_TODAY_ONLY = (11, 167)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 168)
    DECK_CONFIG_UPDATING_CARDS = (11, 169)
    DECK_CONFIG_USED_BY_DECKS = (11, 170)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 171)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 172)
    DECK_CONFIG_WEIGHTS = (11, 173)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 174)
    DECK_CONFIG_WHICH_DECK = (11, 175)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 176)
